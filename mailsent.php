...
<html>
    <head>
        ...
        <meta name="description" content="sample"><!--2.説明文-->
        <meta name="keywords" content="sample"><!--3.キーワード-->
    ...
    <div class="wrap">
        ...
        <div class="main-body">
            ...
            <div class="arti">
                <h1>お問い合わせフォーム</h1>
                <a href=index.html><img class="logo" src="img\Pac.png"></a><p class="open_day">公開日 2023/**/△△</p>
                <div class="php">
                <?php
